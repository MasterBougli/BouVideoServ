...
![Version](https://img.shields.io/badge/version-v0.2.2-31d0aa)
...
- Status: camera-by-camera configuration, dashboard states, and LAN profile page
...
- [Camera connection](web/camera.html)
- [LAN profile](web/lan.html)
